...
-->
            ...
            <?php
//$a = null;
            $query = "SELECT * FROM committee group by committee_name HAVING hod_verified = 0";
            ...
            for($i=1; $i<=$num; $i++){
                ...
                <div class="col-xs-4 col-sm-6 col-md-6 col-lg-5" style="background-color:#CEE5F2;margin:30px 0px 0px 55px;height:200px">
                    ...
                    <p>Status : Pending</p>
                    <a href="hod_students_list.php?committee_id=<?php echo $row['id']?>" style="color:#fff; background:#b0413e; padding:7px; padding-left:20px; padding-right:20px; text-decoration:none;">Verify</a>
...
toastr.options = {
  ...
  "hideMethod": "fadeOut"
        ...
        toastr["success"]("You have successfully Logged In","HOD");
