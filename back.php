    ...
    <div class="container-fluid">
        ...
        ?>
            ...
            <div class="col-md-7" style="background-color: #b0413e; padding: 20px;">
                <div>
                    <img src="images/t1.png" alt="" style="height: 500px; width: 650px; padding: 30px; margin: 30px; margin-left: 100px;">
                </div>
                    <div class="row">
                    <div class="col-md-4">
                    </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
         ...
         <div class="modal-footer">
          <button type="submit" class="btn btn-default" style="background:#008000; color:#fff;">Submit</button>
